...
Lab completed on 2026-08-04. Evidence collected under `evidence/buoi-01` includes the smoke test results, image list, tool versions, and a minimal `service-boundary.md` to satisfy verification. Run `python .\scripts\verify_submission.py` to re-check locally.
